...
@Component
class DisableInstancesTaskGrab implements CloudProviderAware, Task {
  ...
  TaskResult execute(@Nonnull StageExecution stage) {
    ...
    if (loadBalancers && targetGroupNames) {
      ...
      def context = gson.fromJson(jsonString) as Map<String, Object>
      context.remove("targetGroupNames")
      actions += ([deregisterInstancesFromLoadBalancer: context])

      context = gson.fromJson(jsonString) as Map<String, Object>
